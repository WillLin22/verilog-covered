...
class MyParser(argparse.ArgumentParser):
    ...
    def __init__(self):
        ...
        self.add_argument('--analyse-output-file', type=str, default=None, help='The output file name for the analysis results. If None, the name will be generated by input file name and io name')
