...
class MyParser(argparse.ArgumentParser):
    ...
    def __init__(self):
        ...
        code_group.add_argument('--get-modified-code', action='store_true', help='Get modified code')
        code_group.add_argument('--add-variables', action='store_true', help='Add middle vars into code')
        ...
        analyse_group.add_argument('--dist-factor-zero', type=int, help='Parameter for the distance factor for analysis')
